...
- [ ] **Калибровка каскада Fit→P(win)→Margin (ADR-9)** — подобрать пороги переходов
      (`pwin_fit_threshold`/`margin_pwin_threshold`), коэффициенты формулы P(win)
      ...
      P(win) (`pwin_service` config `use_stub: true` → `false`).
