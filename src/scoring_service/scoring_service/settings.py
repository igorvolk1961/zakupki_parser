...
class Settings(BaseSettings):
    ...
    # Проверять SSL-сертификат при скачивании файла ТЗ. Площадки за
    # TLS-перехватом (VPN/корпоративный прокси) отдают самоподписанный
    # промежуточный сертификат — для локальной разработки можно выключить.
