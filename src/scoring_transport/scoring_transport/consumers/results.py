    ...
    async def _process_once(self) -> None:
        ...
        try:
            ...
            await self._parser.post_score(
                ...
                auto_rejected=payload.get("auto_rejected"),
                auto_rejection_reason=payload.get("auto_rejection_reason"),
                analysis_profile_snapshot=payload.get("analysis_profile_snapshot"),
