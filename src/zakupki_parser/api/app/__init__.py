"""FastAPI-сервис: чтение закупок из БД, web-интерфейс и управление парсером.
...
from zakupki_parser.api.app.routes.conditions import build_conditions_router
...
def create_app(configs_dir: str = "configs", port: int = 8000) -> FastAPI:
    ...
    app.include_router(build_conditions_router(ctx))
    return app
