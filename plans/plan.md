...
- **МVP в работе:** Этап 4 → 4B (параллельные площадки, R5) — выполнено; детальный
  план `plans/04_plan.md`. Кэш ЭТП 4A перенесён в пост-MVP (ADR-11);
  `profile_then_platform` удалена.
...
- Дальше по MVP: Этап 5 (маркеры ТЗ).
- Пост-MVP: Этапы 6, 4C, 7, 8, 9, 10 (кэш 4A — вместе с 4C/10).
