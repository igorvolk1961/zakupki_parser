...
| `lot_online_44` | lot-online РАД | 44-ФЗ | ✅ список (вкл. даты); детали — TODO (SPA) | частично | **вкл** |
...
| `lot_online_223` | lot-online РАД | 223-ФЗ | ✅ список (вкл. даты); детали — TODO (SPA) | частично | **вкл** |
