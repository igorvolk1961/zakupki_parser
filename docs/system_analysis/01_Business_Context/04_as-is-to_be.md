...
6. **Шаг 6 — Глубокая проверка ТЗ и обновление карточки** (Эпик 4, v2.0): Система
   выполняет RAG-анализ ТЗ на специфические барьеры (опыт ПП РФ 2571, реестр
   Минпромторга, лицензии и вопросы профиля) и обновляет Карточку статусными маркерами.
